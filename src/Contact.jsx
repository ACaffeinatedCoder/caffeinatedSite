import { faAt, faCircleXmark, faEnvelope, faLocation, faLocationDot, faMobile } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className='cont-container'>
      ...
      <div className='cont-subcontainer'>
        ...
        <div className='contact-item-container'>
          ...
          <div className='contact-item'
            onClick={() => {
              copyToClipboard('https://www.linkedin.com/in/casey-christian-francisco-92b9701bb/', 'LinkedIn url');
              showCopyToast()
            }}
          >
              <FontAwesomeIcon
          ...
          <div className='contact-item'
            onClick={() => {
              copyToClipboard('https://github.com/ACaffeinatedCoder', 'Github profile url');
              showCopyToast()
            }}
          >
              <FontAwesomeIcon
          ...
          (color, index) => {
            ...
            return (
              <div
                ...
                style={{ backgroundColor: color, color: textColor, fontWeight: 'bold' }}>
                <p>{color}</p>
              </div>
            );
          }
